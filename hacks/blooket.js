(async() => {
    ...
    if (console.log("%c BlooketV5 Deblocked %c\n	Updated by Smoreh. Dont get caught!🫡", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	My Github for MORE hacks :D %c  https://github.com/8Bit-CCieCollab-Smore/DeblockedHacks", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
            ...
            display: "block"
                ...
                style: {
                    ...
                    overflow: "hidden"
                        ...
                        innerHTML: "Youtube - Smoreh",
                        onclick: () => window.open("https://www.youtube.com/@Smoreh", "_blank").focus()
                    }), $ = l("div", {
                        id: "controlButtons",
                        style: {
                            display: "flex",
                            ...
                            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Cheats<sup>v5</sup></span>'
                        }, l("a", {
                                className: "bigButton",
                                style: {
                                    cursor: "pointer",
    ...
    let C = {
        global: [{
                ...
                name: "Auto Answer",
                description: "Automaticly Clicks the Answers with ZERO Delay",
                run: function () {
                    let {
                        state: {
                            question: e,
                ...
                name: "Lobbychat",
                description: "Chat ON the Leaderboard, and execute commands",
                run: function () {
                    if (window.run) {
                        return;
                    } else {
        ...
        credits: [{
                element: l("div", {
                    ...
                    style: {
                        ...
                        const creditsList = [{
                                name: "Kn3ghtfall, Smoreh",
                                description: "Original GUI made 5 years ago, Updated on 2025 by Smoreh, New Features Added: Credits Section, Settings Section, Extras Section, Alets Added, Crypto Hack Edited "
                            }
                        ];
...
w("Alerts", "https://media3.giphy.com/media/v1.Y2lkPTZjMDliOTUyZjU0YWdyMHZndnc1aHJ5OTh2Mm9wNmttODNpajE4ZG15c2NmMjB5cCZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/f4z6vCWrGcMw6xRlOA/giphy.gif", C.alerts, !0),
w("Global", "https://images.emojiterra.com/google/noto-emoji/unicode-16.0/color/1024px/1f30e.png", C.global)(),
...
w('<span style="font-size: 18px">Tower Defense</span>', ['<img style="width: 30px; margin-right: 1px" src="https://cdn3.emoji.gg/emojis/6722-evolving-badge-nitro-animated.gif">'], C.defense),
